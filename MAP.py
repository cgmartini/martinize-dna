...
class CoarseGrained:
    ...
    mapping = {
        ...
        "DA": FUNC.nsplit("P OP1 OP2 O5' H5T O3' H3T O1P O2P",
                          "C5' O4' C4'",
                          "C3' C2' C1'",
                          "N9 C4",
                          "C2 N3",
                          "C6 N6 N1",
                          "C8 N7 C5"),
        "DG": FUNC.nsplit("P OP1 OP2 O5' H5T O3' H3T O1P O2P",
                          "C5' O4' C4'",
                          "C3' C2' C1'",
                          "N9 C4",
                          "C2 N2 N3",
                          "C6 O6 N1",
                          "C8 N7 C5"),
        "DC": FUNC.nsplit("P OP1 OP2 O5' H5T O3' H3T O1P O2P",
                          "C5' O4' C4'",
                          "C3' C2' C1'",
                          "N1 C6",
                          "N3 C2 O2",
                          "C5 C4 N4"),
        "DT": FUNC.nsplit("P OP1 OP2 O5' H5T O3' H3T O1P O2P",
                          "C5' O4' C4'",
                          "C3' C2' C1'",
                          "N1 C6",
                          "N3 C2 O2",
